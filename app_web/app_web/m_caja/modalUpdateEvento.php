  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="05abonar.php" method="post">
        ...
        <div class="card-body">
         <input type="hidden" name="id" class="empid" name="id">
...
<!--          <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="edit_monto"  readonly name="monto_pendiente" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control"  step="any" id="edit_abono" name="monto" required />
          </div>
        </div>
      ...
      <form class="form-horizontal" action="05abonar_pagar.php" method="post">
       ...
       <!--    <div class="form-group row">
            ...
            <div class="col-sm-10">
             ...
             <div class="form-group row">
          <label for="edit_monto_p" class="col-sm-2 control-label">Monto Pendiente:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="edit_monto_p"  readonly name="monto" required>
          </div>
        </div>

          <div class="form-group row">
            <label for="edit_monto_a" class="col-sm-2 control-label">Abono</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="edit_monto_a"  readonly name="abono" required>
            </div>
          </div>
