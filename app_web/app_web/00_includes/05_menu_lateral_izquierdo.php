 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../../dist/img/logocrese.svg" style="background-color: white;" alt="CRESE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
